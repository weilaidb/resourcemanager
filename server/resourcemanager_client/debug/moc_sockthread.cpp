...
struct qt_meta_stringdata_sockthread_t {
    QByteArrayData data[10];
    char stringdata[151];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sockthread_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_sockthread_t qt_meta_stringdata_sockthread = {
    {
...
QT_MOC_LITERAL(9, 142, 8)
    ...
    "sockthread\0emitMsgDoneSignal\0\0emitErrInfo\0"
    "displayErr\0QAbstractSocket::SocketError\0"
    "socketError\0updateReadMsgProgress\0"
    "updateWriteClientProgress\0numBytes"
};
...
void sockthread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->emitMsgDoneSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sockthread::emitMsgDoneSignal)) {
                *result = 0;
            }
        }
        {
...
const QMetaObject sockthread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_sockthread.data,
      qt_meta_data_sockthread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sockthread.stringdata))
...
// SIGNAL 0
void sockthread::emitMsgDoneSignal(QString _t1)
{
